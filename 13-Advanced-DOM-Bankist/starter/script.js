...
const slider = function () {
  ...
  const goToSlide = function (slide) {
    slides.forEach((s, i) => {
      const translateXValue = 100 * (i - slide);

      s.style.transform = `translateX(${translateXValue}%)`;
    });
  };
...
/*
// section creatijng and deleting elements
...
console.log(h1.parentElement.childern);
[...h1.parentElement.childern].forEach(function (el) {
...
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML parsed out and DOM tree built', e);
});
