...
console.log(maskCreditCard(3433570494058954));
console.log(maskCreditCard(76983982543528754598320));
console.log(maskCreditCard('099058324825435287540045'));

//Repeat
const message2 = 'Bad weather... All departs delayed...';
...
// Arrays
// const users = [{ name: 'Thomas', email: 'tommyshelby@gamil.com' }];
const users = [];
...
// use any data type,return any data type, short-cuircuiting
console.log(3 || 'Jonas');
console.log('' || 'Jonas');
console.log(true || 0);
...
console.log('Hello' && 23 && null && 'h=jonas');
